        ...
        <div class="grid gap-10 py-8 sm:grid-cols-12 md:py-12 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.200),transparent)1] ">
            ...
            <div class="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Features</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Integrations</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Pricing & Plans</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Changelog</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Our method</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Diversity & Inclusion</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Blog</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Careers</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Financial statements</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
                ...
                <ul class="space-y-2 text-sm">
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Community</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Terms of service</a></li>
                    <li><a class="text-gray-600 transition hover:text-gray-900" href="#0">Report a vulnerability</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
                ...
                <ul class="flex gap-1">
                    <li>
                        <a class="flex items-center justify-center text-blue-500 transition hover:text-blue-600" href="#0" aria-label="Twitter">
                    ...
                    <li>
                        <a class="flex items-center justify-center text-blue-500 transition hover:text-blue-600" href="#0" aria-label="Medium">
                            <svg class="h-8 w-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a class="flex items-center justify-center text-blue-500 transition hover:text-blue-600" href="#0" aria-label="Github">
                            <svg class="h-8 w-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
